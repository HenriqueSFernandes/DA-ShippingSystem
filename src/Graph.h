...
protected:
    ...
    double capacity; //for flow-related problems
};
...
public:
    ...
    */
    ...
    bool addDirectedEdgeWithResidual(const T &sourc, const T &dest, double w);
...
template<class T>
bool Graph<T>::addDirectedEdgeWithResidual(const T &sourc, const T &dest, double w) {
    auto v1 = findVertex(sourc);
    auto v2 = findVertex(dest);
    if (v1 == nullptr || v2 == nullptr)
        return false;
